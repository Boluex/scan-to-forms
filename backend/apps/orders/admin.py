...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('reference', 'title', 'user', 'service_type', 'status', 'payment_status', 'amount_ngn', 'created_at')
    ...
    def workspace_link(self, obj):
        ...
        return format_html('<a href="{}/orders/{}">Open order, payment rejection, notes and review</a>', settings.FRONTEND_URL, obj.reference)
    ...
    def reject(self, request, queryset):
        self.message_user(request, 'Open the order workspace and choose Reject payment; a reason is mandatory.', messages.WARNING)
